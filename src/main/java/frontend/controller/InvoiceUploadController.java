    ...
    private void addInvoice() {
        ...
        if (invoices != null && invoiceService.invoiceDateAlreadyUsed(date, user)) {
            ...
            if (success) {
                ...
                showAlert("Erfolg", "Rechnung wurde erfolgreich hinzugefügt! Kategorie: " + invoice.getCategory() + "; Rückerstattungsbetrag: " + reimbursementService.getReimbursementAmount());
                resetForm();
            } else {
